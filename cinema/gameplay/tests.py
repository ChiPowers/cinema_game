...
class GameplayTestCase(TestCase):
    def test_game_data_stored_properly(self):
        ...
        game_data = {
            "user": "Test_user",
            "start_contributor": "Cate Blanchett",
            "end_contributor": "Colin Firth",
    ...
    def test_store_game_data_GraphandHTTP(self):
        ...
        self.assertEqual(
            game_details.values_list("start_contributor", flat=True)[0], "949"
        )
        self.assertEqual(
            game_details.values_list("end_contributor", flat=True)[0], "147"
        )
